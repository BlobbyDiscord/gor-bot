...
bot.on('message', function(message){
 if (message.content.toLowerCase() === "g!coinflip"){
 var chance = Math.floor(Math.random() * 2);
 if (chance == 0){message.reply("**Your Coin Landed On `Heads`**" + " :joystick:");}
 else{message.reply("**Your Coin Landed On `Tails`**" + " :joystick:");}
 }
});

bot.on('message', function(message){
 if (message.content.toLowerCase() == "g!love"){
...
bot.on('message', (message) => {
 if(message.content.toLowerCase() == 'g!hello') {
 message.reply("Hello, how was your day?"); 
 }
});


bot.on('message', (message) => {
 if(message.content.toLowerCase() == 'g!weather') {
 message.reply("WIP."); 
 }
});
...
bot.on('message', (message) => {
 if(message.content.toLowerCase() == 'g!invite') {
 message.reply("Enjoy! https://discordapp.com/api/oauth2/authorize?client_id=537027175346601984&permissions=8&scope=bot"); 
 }
});
...
bot.on('guildMemberRemove', member => {
 ...
 .addField('User ID:', "**" + `${member.id}` + "**")
 .addField('Now there are', `${member.guild.memberCount} members in the server.`)
 .addField("Name:", `<@` + `${member.id}` + `>`, true)
 .addField('Server:', `${member.guild.name}`, true )
 .setFooter(`${member.guild.name}`)
 .setTimestamp()
...
//Function knock() returns the formatted joke
 ...
 .setDescription('Name: SirGor#0624, Profile Picture below.')
 .setImage('https://www.mcfcwatch.com/wp-content/uploads/2017/03/aguero-celebrates-boro-17.jpg')
 .setTimestamp()
 message.channel.send(Embed);
 }
 })
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('f200ff')
 .setTitle('Happy Valentines Day! -Gor')
 ...
 .setColor('RANDOM')
 .setTitle('Guilds')
 .setDescription(`The bot is in **${bot.guilds.size}**, servers!`)
 .addField('Users', `Watching **${bot.users.size} Users!**`)
 .addField('Prefix', "g!")
 .addField('Bot Created On', `${bot.user.createdAt}`)
 .setThumbnail(boticon)
 .addField('Support/Official Server', "https://discord.gg/9qXGcE7")
 ...
 .addField('Members Online', `<:discord_online:563141104728408066> ${message.guild.members.filter(m => m.presence.status === "online").size}`)
 .addField('Members on Do Not Disturb', `<:discord_dnd:563141897489743874> ${message.guild.members.filter(m => m.presence.status === "dnd").size}`)
 .addField('Idle Members', `<:discord_idle:563142110900125716> ${message.guild.members.filter(m => m.presence.status === "idle").size}`)
 .addField('Invisible/Offline Members', `<:discord_offline:563142625939423235> ${message.guild.members.filter(m => m.presence.status === "offline").size}`)
 .setTimestamp()
 message.channel.send(embed);
 }
 })
 ...
 bot.on('message', (message) => {
 if (message.content.includes("SuggestionGB")){
 message.react("👍")} 
 });
 ...
 .setColor('RANDOM')
 .setTitle('Help')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/550840246627991554/gorbot_help.png')
 .setDescription('Choose a category, example: g!Fun')
 .addField('To make logs channel, do g!createchannel logs, also to make welcome-leave channel do g!createchannel welcome-leave *Manage channel permissions*', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/565349257066840064/gorbotfun.png')
 .setTitle('__Fun commands.__')
 .addField('g!Unicorn', '󠀀󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Coinflip', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Token', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Hug @user', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Knock', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Tacocat *Minigame*', 'For answers after g!T answers')
 .addField('g!Slots *Minigame*', 'Does not have any currency you can get, just a fun minigame you can spam.')
 .addField('g!Hello', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!KO', '󠀀 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Greet @user', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Ping', 'Pings a random user')
 .addField('g!Rate @user', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .setTimestamp()
 message.channel.send(Embed);
 }
 })
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/565349243397865482/gorbotmod.png')
 .setTitle('__Moderation Commands.__')
 .addField('g!Kick @user', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Ban @user', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Purge <Amount you want to delete>', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Createrole muted', 'this will make the muted role, however will not deny channel permissions. Just role permissions.')
 .addField('g!Mute @user', 'This will give the mentioned user the muted role')
 .addField('g!Vote <Your question here>', '*Needs Manage Messages Permission*')
 .setTimestamp()
 message.channel.send(Embed);
 }
 })
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/565349228675727361/gorbotinfo.png')
 .setTitle('__Information Commands.__')
 .addField('g!Membercount', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Botinfo', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Botcredits', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/565349211059650580/gorbotholiday.png')
 .setTitle('__Holiday Commands.__')
 .addField('g!Love *Not working completely*', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!Valentinesday', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!St patricks', '*Only up for Saint Patricks Day!*')
 .setTimestamp()
 message.channel.send(Embed);
 }
 })
 ...
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setThumbnail('https://cdn.discordapp.com/attachments/533061376625737741/565349223424589853/gorbotmath.png')
 .setTitle('__Math Commands.__')
 .addField('g!calculate *number* + *number*', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!calculate *number* - *number*', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .addField('g!calculate *number/decimal* + or - *number/decimal*', ' 󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀󠀀')
 .setTimestamp()
 message.channel.send(Embed);
 }
 })
...
bot.on('message', (message) => {
 ...
 .addField('Goodbye', 'Anyways goodbye! We hope to see you again!')
...
bot.on('message', (message) => {
 ...
 .setColor('RANDOM')
 .setTitle('Good luck.')
 .setDescription('Good luck! After you find as many words as possible, do g!T Answers.')
...
bot.on('message', (message) => {
 if (message.content.toLowerCase().startsWith(prefix + "t answers")) {
 const Embed = new Discord.RichEmbed()
 .setColor('RANDOM')
 .setTitle('Answers')
...
bot.on('message', (message) => {
 ...
 .setDescription('Congratulations! Your logs channel has been created! You can now log when a channel is created or deleted!')
 .setTimestamp()
...
message.channel.send(`Get pinged ${message.guild.members.random()} hah! Not taking that back either. :P`)
 }
})
...
bot.on('ready', () => { bot.user.setActivity(`g!Help | ${bot.guilds.size} guilds. Updates on the way!`) })
